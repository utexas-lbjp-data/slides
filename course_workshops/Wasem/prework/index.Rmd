...
The first step to get started is by setting up RStudio locally on your desktop. If you have any trouble getting setup, shoot me an email at [matthew.worthington@austin.utexas.edu](matthew.worthington@austin.utexas.edu)
...
We'll need a few R packages, so try installing these. If you have trouble, shoot me an email at [matthew.worthington@austin.utexas.edu](matthew.worthington@austin.utexas.edu):
