...
Under the **Analysis Setup** section, there's a chunk tagged `setup` from lines 32:41.
...
# install.packages(c("janitor", "tidyverse", "readxl"))
...
### 📧: matthew.worthington@utexas.edu
