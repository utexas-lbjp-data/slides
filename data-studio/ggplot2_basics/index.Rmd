...
* ["A coherent system for describing and building graphs"](https://r4ds.had.co.nz/data-visualisation.html) (✔️)
* [A tool for implementing a Grammar of Graphics](https://ggplot2-book.org/introduction.html). (✔️)
* [An R package named ggplot2](https://rmarkdown.rstudio.com/docs/). (✔️)
* [A tool that people build on](https://exts.ggplot2.tidyverse.org) (✔️)
* [A tool for making artwork](https://www.data-imaginist.com/art) (✔️)
* [A tool for reproducible analysis](http://radar.oreilly.com/2011/07/wolframs-computational-documen.html) (✔️)
* Really fun (🚀️)
]
...
.rmd-small[![](https://www.data-imaginist.com/art/011_yonder/yonder1831_hu827b7f9bcd74231a2b6a7030989792b6_784253_0x1000_resize_q75_box.jpg)]

.tl.burntorange[
Credit: Thomas Lin Pederson ([@thomasp85](https://twitter.com/thomasp85))
]
...
.rmd-img[![](https://cdn-images-1.medium.com/max/800/1*MMZuYgeC_YjXNC1r4D4sog.png)]

.tl.burntorange[
Credit: ([Dr Anna Krystalli](https://annakrystalli.me/rrresearchACCE20/plotting-with-ggplot2.html#the-grammar-of-grahics))
]
...
.rmd-img[![](https://cdn-images-1.medium.com/max/800/1*w1RnmuE7VRK9aCAbtW9KAQ.gif)]
...
**What it does:** Loads the data and draws a ggplot2 canvas for your chart

.rmd-tiny[![](assets/images/ggplot_function.png)]
...
.rmd-tiny[![](assets/images/aes_function.png)]
...
.rmd-tiny[![](assets/images/geom_function.png)]
...
**What it does:** Lets you add or adjust labels on your chart, like the Title, Subtitle, X-Axis, Y-Axis, or Caption Labels.

.rmd-tiny[![](assets/images/labs_function.png)]
...
.rmd-tiny[![](assets/images/theme_function.png)]
...
.rmd-tiny[![](assets/images/scale_function.png)]
...
library(ggthemes)     # ggplot2 extension package that has themes + functions

# Import Texas County Data ------------------------------------------------

tx_cnty_data <- read_rds("raw_data/texas_cnty_data.rds") 
...
```{r draw-viz-1, echo=FALSE, message=FALSE, warning=FALSE, fig.retina=3}
...
`r chunk_reveal(title = "# Top 10 - Step by Step", chunk_name = "draw-viz-1", break_type = "auto")`
...
```{r draw-viz-2, echo = FALSE, include = FALSE}
...
`r chunk_reveal(title = "# Map 1 - Step by Step", chunk_name = "draw-viz-2", break_type = "auto")`
...
```{r draw-viz-3, echo = FALSE, include = FALSE}
...
`r chunk_reveal(title = "# Map 2 - Step by Step, chunk_name = "draw-viz-3", break_type = "auto")`

---
class: code80

## Our Data for Charts in Part 3
...
```{r draw-viz-4, echo = FALSE, include = FALSE}
...
`r chunk_reveal(title = "# Scatterplot 1 - Step by Step", chunk_name = "draw-viz-4", break_type = "auto")`

---

# 3. Scatterplot + Trend  2
...
```{r draw-viz-5, echo = FALSE, include = FALSE}
...
`r chunk_reveal(title = "# Scatterplot 2 - Step by Step", chunk_name = "draw-viz-5", break_type = "auto")`
...
```{r draw-viz-6, echo = FALSE, include = FALSE}
...
`r chunk_reveal(title = "# Faceted Plot - Step by Step", chunk_name = "draw-viz-6", break_type = "auto")`
...
#### [#rstats hashtag](https://twitter.com/hashtag/rstats) on twitter
#### [#ggplot2 hashtag](https://twitter.com/hashtag/ggplot2) on twitter
#### [#TidyTuesday hashtag](https://twitter.com/hashtag/TidyTuesday) on twitter
...
https://www.menti.com/f68w7ni8n5
