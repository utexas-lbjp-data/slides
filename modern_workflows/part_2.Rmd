...
subtitle: "Becoming Proficient and Efficient with R and RStudio <html><div style='float:left'></div><hr color='#e2f1fc' size=1px width=1100px></html>"
author: 
- "**Matt Worthington** | M.Ed./M.PAff"
- "Volunteer Data Viz + Texas Data"
...
theme_lbj <- function(base_size=14,base_family="Libre Franklin",title_size=18, subtitle_size=14, caption_size=10, ...) {
  ggplot2::theme_minimal(base_size = base_size,base_family = base_family,...) +
    ggplot2::theme(plot.title = ggplot2::element_text(size = title_size, color= "#2d2d2d", family = "LibreFranklin-Black", margin = margin(t=0, r=0, b=4, l=0)),
                   plot.subtitle = ggplot2::element_text(size = subtitle_size, family = "LibreFranklin-Regular", margin = margin(t=0, r=0, b=4, l=0)),
                   plot.caption = ggplot2::element_text(family="LibreFranklin-Regular", color="#8d8d8d",size=caption_size, lineheight = 1, hjust = 0, vjust=-5,
                                                        margin = margin(t=4, r=0, b=4, l=0)),
                   plot.margin = ggplot2::unit(c(t=1.75, r=1.5, b=2, l=1), "lines"),
                   axis.title.x = ggplot2::element_text(family="LibreFranklin-Bold", size=8, color="#5d5d5d", hjust=1),
                   axis.title.y = ggplot2::element_text(family="LibreFranklin-Bold", size=8, color="#5d5d5d", hjust=1),
                   strip.text = element_text(family="LibreFranklin-Bold", color="#ffffff"),
                   strip.background = element_rect(color="#2d2d2d", fill="#2d2d2d"),
                   legend.title = element_text(family="LibreFranklin-Bold", color="#8d8d8d"),
