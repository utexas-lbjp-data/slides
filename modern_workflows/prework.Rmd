...
xaringanExtra::use_xaringan_extra(c("tile_view", "panelset", "animate_css", "tachyons", "webcam", "broadcast"))
...
* D. Cale Reeves: [d.cale.reeves@utexas.edu](d.cale.reeves@gatech.edu)
...
* Modern Project Workflows, Part 1: Mar 8, 2021
